...
func GetProductCategoryByIDService(id uint) (*ProductCategory, error) { return GetProductCategoryByID(id) }
...
func GetProductTemplateByIDService(id uint) (*ProductTemplate, error) { return GetProductTemplateByID(id) }
...
func GetProductAttributeByIDService(id uint) (*ProductAttribute, error) { return GetProductAttributeByID(id) }
...
func CreateProductAttributeValueService(data *ProductAttributeValue) error { return CreateProductAttributeValue(data) }
func GetAllProductAttributeValueService() ([]ProductAttributeValue, error) { return GetAllProductAttributeValue() }
func GetProductAttributeValueByIDService(id uint) (*ProductAttributeValue, error) { return GetProductAttributeValueByID(id) }
func UpdateProductAttributeValueService(data *ProductAttributeValue) error { return UpdateProductAttributeValue(data) }
...
func GetStockPutawayRuleByIDService(id uint) (*StockPutawayRule, error) { return GetStockPutawayRuleByID(id) }
...
func CreateStockValuationLayerService(data *StockValuationLayer) error { return CreateStockValuationLayer(data) }
func GetAllStockValuationLayerService() ([]StockValuationLayer, error) { return GetAllStockValuationLayer() }
func GetStockValuationLayerByIDService(id uint) (*StockValuationLayer, error) { return GetStockValuationLayerByID(id) }
func UpdateStockValuationLayerService(data *StockValuationLayer) error { return UpdateStockValuationLayer(data) }
