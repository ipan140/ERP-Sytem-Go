...
func GetAllMrpWorkcenter() ([]MrpWorkcenter, error) { var list []MrpWorkcenter; err := config.DB.Find(&list).Error; return list, err }
func GetMrpWorkcenterByID(id uint) (*MrpWorkcenter, error) { var data MrpWorkcenter; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllMrpBom() ([]MrpBom, error) { var list []MrpBom; err := config.DB.Find(&list).Error; return list, err }
func GetMrpBomByID(id uint) (*MrpBom, error) { var data MrpBom; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllMrpBomLine() ([]MrpBomLine, error) { var list []MrpBomLine; err := config.DB.Find(&list).Error; return list, err }
func GetMrpBomLineByID(id uint) (*MrpBomLine, error) { var data MrpBomLine; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllMrpBomByproduct() ([]MrpBomByproduct, error) { var list []MrpBomByproduct; err := config.DB.Find(&list).Error; return list, err }
func GetMrpBomByproductByID(id uint) (*MrpBomByproduct, error) { var data MrpBomByproduct; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllMrpWorkorder() ([]MrpWorkorder, error) { var list []MrpWorkorder; err := config.DB.Find(&list).Error; return list, err }
func GetMrpWorkorderByID(id uint) (*MrpWorkorder, error) { var data MrpWorkorder; err := config.DB.First(&data, id).Error; return &data, err }
