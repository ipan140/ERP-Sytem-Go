...
func GetAllLeaveType() ([]LeaveType, error) { var list []LeaveType; err := config.DB.Find(&list).Error; return list, err }
func GetLeaveTypeByID(id uint) (*LeaveType, error) { var data LeaveType; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllLeaveAllocation() ([]LeaveAllocation, error) { var list []LeaveAllocation; err := config.DB.Find(&list).Error; return list, err }
func GetLeaveAllocationByID(id uint) (*LeaveAllocation, error) { var data LeaveAllocation; err := config.DB.First(&data, id).Error; return &data, err }
