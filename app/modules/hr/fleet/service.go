...
func CreateVehicleLogContractService(data *VehicleLogContract) error { return CreateVehicleLogContract(data) }
func GetAllVehicleLogContractService() ([]VehicleLogContract, error) { return GetAllVehicleLogContract() }
func GetVehicleLogContractByIDService(id uint) (*VehicleLogContract, error) { return GetVehicleLogContractByID(id) }
func UpdateVehicleLogContractService(data *VehicleLogContract) error { return UpdateVehicleLogContract(data) }
...
func CreateVehicleLogServicesService(data *VehicleLogServices) error { return CreateVehicleLogServices(data) }
func GetAllVehicleLogServicesService() ([]VehicleLogServices, error) { return GetAllVehicleLogServices() }
func GetVehicleLogServicesByIDService(id uint) (*VehicleLogServices, error) { return GetVehicleLogServicesByID(id) }
func UpdateVehicleLogServicesService(data *VehicleLogServices) error { return UpdateVehicleLogServices(data) }
