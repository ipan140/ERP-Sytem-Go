...
func GetAllJobPosition() ([]JobPosition, error) { var list []JobPosition; err := config.DB.Find(&list).Error; return list, err }
func GetJobPositionByID(id uint) (*JobPosition, error) { var data JobPosition; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllWorkingSchedule() ([]WorkingSchedule, error) { var list []WorkingSchedule; err := config.DB.Find(&list).Error; return list, err }
func GetWorkingScheduleByID(id uint) (*WorkingSchedule, error) { var data WorkingSchedule; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllContract() ([]Contract, error) { var list []Contract; err := config.DB.Find(&list).Error; return list, err }
func GetContractByID(id uint) (*Contract, error) { var data Contract; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllSkill() ([]Skill, error) { var list []Skill; err := config.DB.Find(&list).Error; return list, err }
func GetSkillByID(id uint) (*Skill, error) { var data Skill; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllSkillLevel() ([]SkillLevel, error) { var list []SkillLevel; err := config.DB.Find(&list).Error; return list, err }
func GetSkillLevelByID(id uint) (*SkillLevel, error) { var data SkillLevel; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllEmployeeSkill() ([]EmployeeSkill, error) { var list []EmployeeSkill; err := config.DB.Find(&list).Error; return list, err }
func GetEmployeeSkillByID(id uint) (*EmployeeSkill, error) { var data EmployeeSkill; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllResumeLine() ([]ResumeLine, error) { var list []ResumeLine; err := config.DB.Find(&list).Error; return list, err }
func GetResumeLineByID(id uint) (*ResumeLine, error) { var data ResumeLine; err := config.DB.First(&data, id).Error; return &data, err }
