...
func init() {
	config.ModelsToMigrate = append(config.ModelsToMigrate, &Account{}, &Journal{}, &JournalEntry{}, &JournalItem{}, &BankStatement{}, &BankStatementLine{}, &AnalyticAccount{}, &AnalyticLine{})
}
