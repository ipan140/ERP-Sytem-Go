...
func GetAllCountry() ([]Country, error) { var list []Country; err := config.DB.Find(&list).Error; return list, err }
func GetCountryByID(id uint) (*Country, error) { var data Country; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllCountryState() ([]CountryState, error) { var list []CountryState; err := config.DB.Find(&list).Error; return list, err }
func GetCountryStateByID(id uint) (*CountryState, error) { var data CountryState; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllPartner() ([]Partner, error) { var list []Partner; err := config.DB.Find(&list).Error; return list, err }
func GetPartnerByID(id uint) (*Partner, error) { var data Partner; err := config.DB.First(&data, id).Error; return &data, err }
