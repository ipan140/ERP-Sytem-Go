...
func CreateQuotationTemplateService(data *QuotationTemplate) error { return CreateQuotationTemplate(data) }
func GetAllQuotationTemplateService() ([]QuotationTemplate, error) { return GetAllQuotationTemplate() }
func GetQuotationTemplateByIDService(id uint) (*QuotationTemplate, error) { return GetQuotationTemplateByID(id) }
func UpdateQuotationTemplateService(data *QuotationTemplate) error { return UpdateQuotationTemplate(data) }
...
func CreateSaleOrderLineService(data *SaleOrderLine) error {
	...
	if err := CreateSaleOrderLine(data); err != nil { return err }
...
func UpdateSaleOrderLineService(data *SaleOrderLine) error {
	data.SubTotal = data.Quantity * data.UnitPrice * (1 - (data.Discount / 100))
	if err := UpdateSaleOrderLine(data); err != nil { return err }
	return RecalculateSaleOrder(data.OrderID)
}
func DeleteSaleOrderLineService(id uint) error {
	...
	if err := DeleteSaleOrderLine(id); err != nil { return err }
