...
func GetAllSalesTeam() ([]SalesTeam, error) { var list []SalesTeam; err := config.DB.Find(&list).Error; return list, err }
func GetSalesTeamByID(id uint) (*SalesTeam, error) { var data SalesTeam; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllStage() ([]Stage, error) { var list []Stage; err := config.DB.Find(&list).Error; return list, err }
func GetStageByID(id uint) (*Stage, error) { var data Stage; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllActivity() ([]Activity, error) { var list []Activity; err := config.DB.Find(&list).Error; return list, err }
func GetActivityByID(id uint) (*Activity, error) { var data Activity; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllSalesCommission() ([]SalesCommission, error) { var list []SalesCommission; err := config.DB.Find(&list).Error; return list, err }
func GetSalesCommissionByID(id uint) (*SalesCommission, error) { var data SalesCommission; err := config.DB.First(&data, id).Error; return &data, err }
