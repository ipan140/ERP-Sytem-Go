...
func GetAllPosConfig() ([]PosConfig, error) { var list []PosConfig; err := config.DB.Find(&list).Error; return list, err }
func GetPosConfigByID(id uint) (*PosConfig, error) { var data PosConfig; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllPosOrder() ([]PosOrder, error) { var list []PosOrder; err := config.DB.Find(&list).Error; return list, err }
func GetPosOrderByID(id uint) (*PosOrder, error) { var data PosOrder; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllPosOrderLine() ([]PosOrderLine, error) { var list []PosOrderLine; err := config.DB.Find(&list).Error; return list, err }
func GetPosOrderLineByID(id uint) (*PosOrderLine, error) { var data PosOrderLine; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllPosPayment() ([]PosPayment, error) { var list []PosPayment; err := config.DB.Find(&list).Error; return list, err }
func GetPosPaymentByID(id uint) (*PosPayment, error) { var data PosPayment; err := config.DB.First(&data, id).Error; return &data, err }
...
func GetAllLoyaltyProgram() ([]LoyaltyProgram, error) { var list []LoyaltyProgram; err := config.DB.Find(&list).Error; return list, err }
func GetLoyaltyProgramByID(id uint) (*LoyaltyProgram, error) { var data LoyaltyProgram; err := config.DB.First(&data, id).Error; return &data, err }
