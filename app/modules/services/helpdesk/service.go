...
func CreateHelpdeskCannedResponseService(data *HelpdeskCannedResponse) error { return CreateHelpdeskCannedResponse(data) }
func GetAllHelpdeskCannedResponseService() ([]HelpdeskCannedResponse, error) { return GetAllHelpdeskCannedResponse() }
func GetHelpdeskCannedResponseByIDService(id uint) (*HelpdeskCannedResponse, error) { return GetHelpdeskCannedResponseByID(id) }
func UpdateHelpdeskCannedResponseService(data *HelpdeskCannedResponse) error { return UpdateHelpdeskCannedResponse(data) }
