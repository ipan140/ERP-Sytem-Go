...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/calendar/events": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter berdasarkan Modul (contoh: hr.leaves)",
                        "name": "model",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Isian Jadwal (Kirim array attendee_ids untuk peserta)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/calendar/events/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID Jadwal (Contoh: 1)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Data baru untuk jadwal ini",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Gagal update jadwal",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/hr/employees/department/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
